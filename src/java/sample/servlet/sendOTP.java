...
public class sendOTP extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(email!=null){
                out.print("<p>please, check your email: "+email+", a confirm code is sent to you</p>");
            }else{
                out.print("<p>can't find your email</p>");
            }  
            out.print("<p>Click <a href=\"index.jsp\">here</a> to go to the homepage </p>");
