<%-- 
    Document   : viewPlant
    Created on : Nov 4, 2022, 1:38:29 AM
    Author     : tuank
--%>
...
<html>
    ...
    <body>
        ...
        <table>
            ...
            <tr>
                <td rowspan="8"><img src="<jsp:getProperty 
                                         name="plantObj" property="imgpath"></jsp:getProperty>" 
                                         class="planting"></td>
                </tr>
                <tr>
                ...
                <tr><td><a href="viewCart.jsp">Back to View cart</a></td></tr>
            </table>
